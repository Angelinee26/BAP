                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Kode Mata Kuliah</th><th>Mata Kuliah</th><th>SKS</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($matakuliahangeline as $item)
                                    <tr>
                            ...
                            <div class="pagination-wrapper"> {!! $matakuliahangeline->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
